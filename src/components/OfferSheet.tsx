    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-4" role="dialog" aria-modal="true">
      <Card elevation={3} className="w-full max-w-md rounded-2xl p-5">
        <div className="flex items-start gap-3">
          <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-amber-500/15 text-amber-500">
            <Package className="size-6" />
          </div>
          <div className="flex-1">
            <p className="text-sm font-bold text-umber-50">Tawaran Pengiriman Baru</p>
            <p className="mt-0.5 text-xs text-umber-400">
        ...
        <div className="mt-3 text-center">
          <button onClick={dismiss} className="text-[11px] text-umber-500 underline">
            Nanti
          </button>
        </div>
      </Card>
